...
def puzzle_room(): # Call to select and run a puzzle room - returns nothing
    ...
    def aces():
        ...
        return
    def rusky_roulette():
        global fatal_bullet, current_bullet, fake_death
        ...
        current_bullet = 6
        def player_turn_rusky():
            global player_health, current_bullet
            input("\nPull the trigger...")
        ...
        def dimitri_turn():
            ...
            if current_bullet == fatal_bullet:
                ...
                print("\nBANG!")
                sleep(3)
                print("\nDimitri sits before you, looking very disappointed...")
                sleep(1)
                print("\n'This is immortality...\n\ngig is a real downer' he mumbles.\n\nDimitri thanks you for your efforts and awards you appropriately.")
                prize_give(level)
                return True
            else:
                print("\nCLICK!")
